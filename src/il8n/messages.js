...
export const messages = {
    ...
    [LOCALES.ENGLISH]: {
        "home.select language":"Select your prefered language",
          ...
          "lock-auth-type" : "Lock AUTH types",
          "lock-auth-type-inst": "An individual can decide to lock/unlock specific Authentication Types (Demographic/Biometrics) of his/her UIN/VID for security reasons",
          "lock-auth-type-action": "Are you sure you want to lock your authentication type",
    ...
    [LOCALES.AMHARIC]: {
      ...
      "lock-auth-type" : "የAUTH አይነቶችን ቆልፍ",
      "lock-auth-type-inst": "አንድ ግለሰብ ለደህንነት ሲባል የእሱ/ሷ UIN/VID የተወሰኑ የማረጋገጫ አይነቶችን ለመቆለፍ/ለመክፈት መወሰን ይችላል።",
      "lock-auth-type-action": "እርግጠኛ ነህ የማረጋገጫ አይነትህን መክፈት ትፈልጋለህ",
