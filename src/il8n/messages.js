...
export const messages = {
    ...
    [LOCALES.ENGLISH]: {
        "home.select language":"Select your prefered language",
          ...
          "lock-auth-type-action": "Are you sure you want to unlock your authentication type",
    ...
    [LOCALES.AMHARIC]: {
      ...
      "lock-auth-type-inst": "አንድ ግለሰብ ለደህንነት ሲባል የእሱ/ሷ UIN/VID የተወሰኑ የማረጋገጫ አይነቶችን (ስነሕዝብ/ባዮሜትሪክስ) ለመቆለፍ/ለመክፈት መወሰን ይችላል።",
      "lock-auth-type-action": "እርግጠኛ ነህ የማረጋገጫ አይነትህን መክፈት ትፈልጋለህ",
      "unlock-auth-type" :"የAUTH አይነቶችን ይክፈቱ",
      "unlock-auth-type-inst": "አንድ ግለሰብ ለደህንነት ሲባል የእሱ/ሷ UIN/VID የተወሰኑ የማረጋገጫ አይነቶችን (ስነሕዝብ/ባዮሜትሪክስ) ለመቆለፍ/ለመክፈት መወሰን ይችላል።",
