...
const InputBar = (props) => {
  ...
  <>
        ...
        <div class="md:container  mx-auto mt-32 bg-[#e8e8e8] border-2 border-[#f6f6f6] rounded-3xl h-50 w-50 p-20">
        {loading? 
        ...
        <Spinner/>
         ...
         <>
          ...
          <form  className="p-15" onSubmit={handleGoState}>
                ...
                <div class="flex items-center justify-center p-3 mr-64 mb-5">
                ...
                <div className="flex items-center justify-center p-1 mr-96 md:p-2">
                ...
                <div class="justify-center items-center p-1 mt-8 mr-96">
                    <button type="submit"  class="inline-block px-7 py-3  bg-[#005471] text-white font-small text-base w-1/2 leading-tight uppercase rounded-xl shadow-md hover:bg-[#083247] hover:shadow-lg focus:bg-[#214b60] focus:shadow-lg focus:outline-none focus:ring-0 active:bg-[#304f55] active:shadow-lg transition duration-150 ease-in-out"><FormattedMessage id="go"/></button>
                </div>
